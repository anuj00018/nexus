  ...
  ],
  {
    variants: {
      variant: {
        ...
        // Electric blue accent button — highlighted actions
        accent: [
          'bg-nexus-electric text-white',
          'hover:bg-nexus-electric-light',
        ...
        // Link style
        link: [
          'bg-transparent text-nexus-electric underline-offset-4',
          'hover:underline',
          'h-auto p-0',
        ],
      },
